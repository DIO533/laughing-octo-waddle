...
%   - 性能对比分析
    ...
    try
        ...
        % 图表1: NEDC工况 - 基准策略
        fprintf('1/6 生成 NEDC工况-基准策略 图表...\n');
        results_nedc_baseline = main('baseline', 'NEDC');
        ...
        % 图表2: NEDC工况 - 优化策略
        fprintf('2/6 生成 NEDC工况-优化策略 图表...\n');
        results_nedc_optimized = main('optimized', 'NEDC');
        ...
        % 图表3: UDDS工况 - 基准策略
        fprintf('3/6 生成 UDDS工况-基准策略 图表...\n');
        results_udds_baseline = main('baseline', 'UDDS');
        ...
        % 图表4: UDDS工况 - 优化策略
        fprintf('4/6 生成 UDDS工况-优化策略 图表...\n');
        results_udds_optimized = main('optimized', 'UDDS');
        ...
        % 图表5: NEDC工况 - 策略对比
        fprintf('5/6 生成 NEDC工况-策略对比 图表...\n');
        results_nedc_comparison = main('comparison', 'NEDC');
        ...
        % 图表6: UDDS工况 - 策略对比
        fprintf('6/6 生成 UDDS工况-策略对比 图表...\n');
        results_udds_comparison = main('comparison', 'UDDS');
