...
%   - 性能对比分析
    ...
    try
        ...
        results_nedc_factor = main('factor_analysis', 'NEDC', 'plot', false);
        analysis_results.nedc_factor = results_nedc_factor;
        visualization_enhanced(results_nedc_factor, 'factor_analysis', 7);
        fprintf('    ✓ 完成 %d 种因素的分析\n', ...
                length(fieldnames(results_nedc_factor.factor_results)));
        
        % 图表8: UDDS工况 - 单因素分析
        fprintf('8/8 生成 UDDS工况-单因素分析 图表...\n');
        results_udds_factor = main('factor_analysis', 'UDDS', 'plot', false);
        analysis_results.udds_factor = results_udds_factor;
        visualization_enhanced(results_udds_factor, 'factor_analysis', 8);
        fprintf('    ✓ 完成 %d 种因素的分析\n', ...
                length(fieldnames(results_udds_factor.factor_results)));
